          ...
          <Stack spacing={4}>
            ...
            >
              <Feature  
                ...
                iconBg={"#fff"}
                text={ <Text  transition="transform 0.5s" _hover={{textColor: "#FBC02D" , transform: 'scale(1.05)', cursor: 'pointer' }} fontSize={{base:"0.7rem",md:"1rem"}} color={'yellow.500'}>"The Stanley Hotel (Estes Park, Colorado, USA):"</Text>}
              />
              <Feature 
              
                icon={<Icon transition="transform 0.5s" _hover={{ transform: 'scale(1.05)', cursor: 'pointer' }} as={IoSearchSharp} color={'green.500'} w={5} h={5} />}
                iconBg={"#fff"}
                text={ <Text fontSize={{base:"0.7rem",md:"1rem"}} color={'yellow.500'} transition="transform 0.5s" _hover={{textColor: "#FBC02D" , transform: 'scale(1.05)', cursor: 'pointer' }}>"Tower of London (London, England):"</Text>}
              />
              <Feature
                icon={<Icon as={IoSearchSharp} color={'purple.500'} w={15} h={15} />}
                iconBg={"#fff"}
                text={<Text  transition="transform 0.5s" _hover={{ textColor: "#FBC02D" ,transform: 'scale(1.05)', cursor: 'pointer' }} fontSize={{base:"0.7rem",md:"1rem"}} color={'yellow.500'}>"Eastern State (Philadelphia, Pennsylvania, USA):"</Text>}
              />
